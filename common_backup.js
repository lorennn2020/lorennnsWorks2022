jQuery(document).ready(function() {
    ...
    function taking() {
        if ($clicking.hasClass("gotSeaWorm") == true){
            $taking = 1;
            $("#ingredientsBlock #A").addClass("seaWorm");

        }else if($clicking.hasClass("gotDesertWorm") == true){
            $taking = 2;
            $("#ingredientsBlock #A").addClass("desertWorm");
        }else{
    ...
    // 從#ingredientsBlock #A 開始放
    // function whichWorm(){
        // console.log("$bag_spaceLR:",$bag_spaceLR);

        // if ($taking == 1 && $("#ingredientsBlock #A").hasClass("desertWorm") == false) {
        //     $("#ingredientsBlock #A").addClass("seaWorm");
        //     console.log("1");
        //     mousePosA();

        // }else if($taking == 1 && $("#ingredientsBlock #A").hasClass("desertWorm") == true ){
        //     $("#ingredientsBlock #B").addClass("seaWorm");
        //     console.log("2");
        //     mousePosB();

        // }else if($taking == 2 && $("#ingredientsBlock #A").hasClass("seaWorm") == false){
        //     $("#ingredientsBlock #A").addClass("desertWorm");
        //     console.log("3");
        //     mousePosA();

        // }else if($taking == 2 && $("#ingredientsBlock #A").hasClass("seaWorm") == true){
        //     $("#ingredientsBlock #B").addClass("desertWorm");
        //     console.log("4");
        //     mousePosB();
    ...
    function mousePosA() {
        ...
        $(document).mousemove(function(e) {
            // if ($("#ingredientsBlock #A").hasClass("full") == false && ($taking == 1 || $taking == 2)) {
    ...
    //     ingredientsMoveB();
    //     $(document).mousemove(function(e) {
    //         if ($("#ingredientsBlock #B").hasClass("full") == false && ($taking == 1 || $taking == 2)) {
    //             $mousePos(e);
    //             ingredientsMoveB();
    //         }
    //     });
    ...
    function ingredientsMoveA() {
        $("#ingredientsBlock #A i").css({
            "position":"fixed",
            "top":$mousePosY+"px",
            "left":$mousePosX+"px",
        });
    ...
    // function ingredientsMoveB() {
    //     $("#ingredientsBlock #B i").css({
    //         "position":"fixed",
    //         "top":$mousePosY+"px",
    //         "left":$mousePosX+"px",
    //     });
    ...
    // $("#ingredientsBlock #A").click(function(){
    $("#ingredientsBlock").click(function(){
        ...
        // if ($("#ingredientsBlock #A").hasClass("full") == false) {
        ...
        //     });
        //     $ingredientsBlock = 1;
        //     if ($(this).children("#A").children().css("position") == "absolute") {
        //         $("#ingredientsBlock #A").addClass("full");
        //         // 是否finalEnding？
        //         if ($(this).children("#A").hasClass("full") == true && $(this).children("#B").hasClass("full") == true) {
        //             finalEnding();
        //         }
        ...
        // } else {
        //     $(this).children("#B").children().css({
        //         "position":"absolute",
        //         "top":"0px",
        //         "left":"-3px",
        //     });
        //     $ingredientsBlock = 2;
        //     if ($(this).children("#B").children().css("position") == "absolute") {
        //         $("#ingredientsBlock #B").addClass("full");
        //         // 是否finalEnding？
        //         if ($(this).children("#A").hasClass("full") == true && $(this).children("#B").hasClass("full") == true) {
        //             finalEnding();
    ...
    $("#frame_home , #frame_home div:not(#ingredientsBlock)").click(function(){
        ...
        // if ($taking == 1) {
        //     $("#ingredientsBlock span.seaWorm:not(.full)").removeClass("seaWorm");
        // } else if($taking == 2) {
        //     $("#ingredientsBlock span.desertWorm:not(.full)").removeClass("desertWorm");
        // }
        $("#bag").removeClass("taking");
    ...
    if ($("#frame_doctors").hasClass("open") == true) {
        // 模糊效果
        for (let $i = 5; $i < 21; $i++) {
            console.log("$i:",$i);
        ...
        $("#frame_doctors #doctors_homeSadCTA").click(function() {
            ...
            setTimeout(function(){
                // map icon 出現
                $("#frame_btnBtm .btn_bag").css("left","0px");
                $("#frame_btnBtm .btn_map").css("bottom","0px");
            }, 37800);
    ...
    //(食材集齊後)動畫：膠囊倒入鍋子，煮出貓貓先食凍，貓貓吃下去，ＥＮＤＩＮＧ
